...
export class AppComponent {
  ...
  generatePDF(action = 'open') {
    let docDefinition = {
      content: [
        ...
        {text: 'Customer Details', style: 'sectionHeader'}, {
          columns: [
            [
              ...
              {text: this.invoice.address}, {text: this.invoice.email},
        ...
        {text: this.invoice.additionalDetails, margin: [0, 0, 0, 15]}, {
          columns: [
  ...
  addProduct() {
    this.invoice.products.push(new Item());
  }
